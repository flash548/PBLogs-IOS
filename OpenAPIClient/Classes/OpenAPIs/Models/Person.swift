...
public struct Person: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, roleAssignments: [RoleAssignment]? = nil, callSign: String? = nil, lastName: String? = nil, firstName: String? = nil, contactNumber: String? = nil, email: String? = nil, dodId: Int64? = nil, isPlaceholder: Bool, rankId: Int? = nil, organizationStatus: [String: OrganizationStatus]? = nil, primaryOrganizationId: UUID? = nil, chatUserId: String? = nil, chatUserName: String? = nil, defaultRole: String? = nil, last4: Int? = nil, createdBy: UUID? = nil, lastModifiedBy: UUID? = nil, createdDate: Date? = nil, lastModifiedDate: Date? = nil) {
        self.id = id
