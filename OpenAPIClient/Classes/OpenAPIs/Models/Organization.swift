...
/** An entity that contains people and events */
public struct Organization: Codable, JSONEncodable, Hashable {
    ...
    public init(parent: UUID? = nil, numMembers: Int64? = nil, daysLastScheduledEvent: Int64? = nil, organizationId: UUID, organizationName: String, armsOrganizationId: String? = nil, harmCode: String? = nil, isSchedulingUnit: Bool? = nil, branchId: Int? = nil, type: ModelType? = nil, chatTeams: [ChatTeam]? = nil, isPblEnabled: Bool? = nil, isArmsEnabled: Bool, armsProgramCode: ArmsProgramCodeEnum? = nil, createdBy: UUID? = nil, lastModifiedBy: UUID? = nil, createdDate: Date? = nil, lastModifiedDate: Date? = nil) {
        self.parent = parent
