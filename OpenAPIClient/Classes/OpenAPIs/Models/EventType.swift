...
/** A generic object that can represent any event type */
public struct EventType: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, icon: String, id: Int, tag: String, organizationId: UUID, color: String? = nil, active: Bool, personnelSelectType: Int, eventFields: [EventField]? = nil, preCrewRest: Int? = nil, customPostCrewRest: Int? = nil, postCrewRest: PostCrewRest? = nil, defaultJobRoles: [DefaultEventJobRole]? = nil, creatableByMember: Bool, index: Double, chatTeamId: Int? = nil, chatTeamName: String? = nil, showOnBigBoard: Bool? = nil, createdBy: UUID? = nil, lastModifiedBy: UUID? = nil, createdDate: Date? = nil, lastModifiedDate: Date? = nil) {
        self.name = name
        self.icon = icon
        self.id = id
        self.tag = tag
